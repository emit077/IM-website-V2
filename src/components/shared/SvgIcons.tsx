...
export function SparklesIcon() {
  return (
    ...
    >
      ...
      <path d="M20 14l.6 2.2L23 17l-2.4.8L20 20l-.6-2.2L17 17l2.4-.8L20 14z" />
    </svg>
  );
}
...
export function WhatsAppIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M20 11.5a8.5 8.5 0 0 1-12.7 7.4L4 20l1.1-3.3A8.5 8.5 0 1 1 20 11.5z" />
      <path d="M8.2 10.3c.5 1.5 1.8 2.8 3.3 3.3" />
      <path d="M9.4 8.7l.8-.4" />
    </svg>
  );
}

export function MentorMarkIcon() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M9.5 12.2c.8.8 1.6 1.2 2.5 1.2 1.3 0 2.3-.8 2.3-2" />
    </svg>
  );
}
...
export function CheckMiniIcon() {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="mt-0.5 h-4 w-4 text-blue-600 dark:text-blue-300"
      aria-hidden="true"
    >
...
export function MessageIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M21 15a4 4 0 0 1-4 4H8l-5 1 1-5V7a4 4 0 0 1 4-4h9a4 4 0 0 1 4 4z" />
      <path d="M7.5 9h9" />
      <path d="M7.5 13h6" />
    </svg>
  );
