  ...
  return (
    ...
    >
      <div className="relative mx-auto max-w-[1200px] overflow-hidden rounded-[2rem] border border-black/[0.06] bg-white px-5 py-10 shadow-[0_20px_50px_rgba(15,23,42,0.06)] md:px-10 md:py-12">
        <div
          className="pointer-events-none absolute -right-20 top-0 h-64 w-64 rounded-full bg-blue-600/[0.11] blur-3xl"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute -left-16 bottom-0 h-48 w-48 rounded-full bg-[#FFD600]/18 blur-3xl"
          aria-hidden
        />
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    isActive
                      ? "bg-[#1a2744] text-white shadow-md shadow-[#1a2744]/25"
        ...
        <div className="relative z-[1] mt-5">
            ...
            {materials.map((m) => (
              <a
                ...
                className={[
                  ...
                  "hover:border-blue-600/25 hover:shadow-[0_12px_28px_rgba(37,99,235,0.08)]",
                  "focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/35",
                  m.panel,
                ].join(" ")}
              >
                <div
                ...
                <span className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-blue-700 opacity-90 group-hover:opacity-100">
                  Open
          ...
          <button
            type="button"
            onClick={scrollNext}
            className="absolute -right-1 top-1/2 z-10 hidden h-10 w-10 -translate-y-1/2 items-center justify-center rounded-xl border border-slate-200 bg-white text-[#1a2744] shadow-md transition hover:border-blue-600/35 hover:text-blue-700 md:flex"
